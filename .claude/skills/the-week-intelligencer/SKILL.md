---
name: the-week-intelligencer
description: Generate this week's issue of The Week Intelligencer — a New York Times–style AI-industry digest rendered as a self-contained HTML page. Use when the user asks to build, generate, or refresh the weekly AI issue. Deterministic feed/NewsAPI sources are gathered by Python scripts (zero tokens); you fill `search` sources with web search and write the editorial summaries.
---

# The Week Intelligencer — issue orchestrator
